...
For the poll scenario 2, the margin of error is five. The headline is not statistically justified because the margin of error signifies that the data can fall at half of the sample or to 60%, as well. 
--  What alternative headline would be more accurate?
"Approximately Half Supports New City Policy"
...
Recent data suggests that the new transit line has caused an increase in home prices. 

Previously the average home cost $285K, but following the construction of the train the average home price has increased by 7%, to a new price of $304.5K. 
