...
The years that had the highest crime rates was the year 1980, with a total rate of 662.7243. The year with the lowest crime rate was 2020. The common trend I have found in the data is that the total crime rates decrease as the years go on, which I did not expect. However, I think it generally makes sense the year 2020 had one of the lower crime rates among the years since for majority of the year we were in quarantine.    
