...
Looking at the raw data numbers, Baltimore City seems to be the most diverse. 
...
Summerfield has the highest race probability since they have a high number of Black residents, with around 93%. 
...
I noticed that the city with the lowest Hisp_prob score has around 44%, while the non-hispanic probability is around 55%. 
...
Langley Park, Wheaton and Adelphi are the cities with the highest diversity index scores. 

Langley Park and Adelphi are a part of the same county, Prince George's County, while Wheaton is in an adjacent county: Montgomery County. This could reflect that the region where these counties are located are more diverse compared to other regions within Maryland. 

Lake Shore, which is Anne Arundel County, has the lowest Diversity Index score nearly 16%. This city closer to regions that tend to be more wealthy. 
...
"Two Maryland cities rank high in diversity between residents" 

Langley Park and Adelphi, located in Prince George's County, ranked the highest in diversity amongst its residents, according to their Diversity Index Score, which suggests the liklihood that two random people chosen from the same city will be of different backgrounds. At the lowest of the rankings sat Lake Shore, located in Anne Arundel County.
