...
Private college students reported a higher average SAT score with a mean score of 1435.026, while community college students reported a lower average SAT score of 1068.070. Additionally, the SAT scores for private college students has the smallest standard deviation, suggesting that the scores are more closely spread around the average SAT score. Conversely, the students' SAT scores in community college show a larger standard deviation of 142.48, which suggests the scores are further spread out from the average score of 1068.070.
...
1. Is there a significant difference in SAT scores across college types? There is a high significance difference in SAT scores across college types, which can be proven by the F-statistic, which is at 284.3, and passes all of the critical value thresholds of the ANOVA test. The p-value for the results also pass the thresholds for significance.  
2. Which specific college types differ from each other? Between public and private college students, the p-value is 2.1e-05, which suggests the results are highly significant in their variance. This comparison is the most significant out of the three comparisons since it is the lesser value of the three p-values from the results.   
3. How large are these differences? According to the Tukey test, the difference between public colleges and privates colleges SAT scores means is -74.40438, while the difference between private and community SAT scores are 366.95. 
...
"Private Colleges show significant gap in SAT scores compared to non-private, data suggests" 

Recent data suggests that students who attend private colleges reported much higher SAT scores compared to those attending public and community college.  
