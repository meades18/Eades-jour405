...
One pattern we notice is that there seems to be an overwhelming amount of overdose 911 calls during 2022 compared to 2023. The day with the most calls was Oct. 4, 2022. 
...
The z-scores back up our observations from Task 3. There were 11 unusually high days with 911 overdose calls, which suggests they were 95% higher than the rest of the days in the dataset. 
...
The day with the highest z-score, which reflects the amount of calls on a given day is higher than the others, is Saturday. However, between the days of the week, there is very low variation of z-scoers. 
...
A potential angle that I would have for the z-score analysis would be about the unusually high call volume on New Year's Day. Some things that would be important to look into if other years have a similar trend, if other holidays show higher call volumes and the drug and alcohol sales during the previous and present day.  
